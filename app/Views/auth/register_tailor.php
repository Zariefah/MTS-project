    ...
    <div class="col-md-6">
      <div class="card">
        <div class="card-header">
          <i class="bi-person-fill-add me-2"></i><strong><?= lang('Auth.login.register') ?> as Tailor</strong></i>
        ...
        <div class="card-body">
          <form action="<?= base_url() ?>/register/tailor" method="post">
            <?= csrf_field() ?>
            <input type="hidden" name="user_type" value="tailor">
            ...
            <div class="mb-3">
              <label for="ssm_registration">SSM Registration Number</label>
              <input type="text" class="form-control <?php if (session('errors.ssm_registration')) : ?>is-invalid<?php endif ?>" name="ssm_registration" id="ssm_registration" placeholder="Enter SSM Registration Number" value="<?= old('ssm_registration') ?>">
              <small class="form-text text-muted">Required for tailor registration</small>
            </div>
          ...
          <hr>
          <!-- <p>Want to register as a customer? <a class="card-link" href="<?= base_url() ?>/register/customer">Register as Customer</a></p> -->
