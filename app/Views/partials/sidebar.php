...
<aside id="sidebar" class="expand">
  <div class="d-flex">
    <button class="sidebar-toggle" type="button">
      <i class="bi bi-arrow-left-right text-white" style="font-size: 28px;"></i>
    </button>
  </div>
  ...
  <ul class="sidebar-nav">
    ...
    <?php if (in_roles('Customer')): ?>
      <!--Measurements-->
      <li class="sidebar-item">
        <a href="<?= base_url('measurements') ?>" class="sidebar-link">
      ...
      <!--View My Tailors-->
      <li class="sidebar-item">
        <a href="<?= base_url('orders/my_tailors_list') ?>" class="sidebar-link">
          <i class="bi bi-person-check"></i>
          <span>My Tailors List</span>
        </a>
      </li>
    ...
    <?php elseif (in_roles('Tailor')): ?>
      <!--Incoming Requests-->
      <li class="sidebar-item">
        <a href="<?= base_url('orders/bid_list') ?>" class="sidebar-link">
      ...
      <!--My Working Jobs-->
      <li class="sidebar-item">
        <a href="<?= base_url('orders/my_orders') ?>" class="sidebar-link">
          <i class="bi bi-list-check"></i>
          <span>My Working Jobs</span>
        </a>
      </li>
      <!--View My Customers-->
      <li class="sidebar-item">
        <a href="<?= base_url('orders/my_customers_list') ?>" class="sidebar-link">
          <i class="bi bi-person-check"></i>
          <span>My Customers List</span>
        </a>
      </li>
    <?php endif; ?>
