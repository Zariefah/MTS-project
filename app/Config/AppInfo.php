...
class AppInfo extends BaseConfig {
   ...
   * @var string
   */
  public $name = 'Modern Tailoring System';
  ...
  /**
   * ------------------------------------------------------------------------
   * Product Icon (used in navbar/sidebar)
   * ------------------------------------------------------------------------
   *
   * @var string
   */
  public $icon = 'images/icons/logo.png';
   ...
   * @var string
   */
  public $description = 'Modern Tailoring System - A System for Tailoring Businesses focus on Small and Medium Tailoring Shops. Based on CodeIgniter 4';
